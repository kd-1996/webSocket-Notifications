...
public class WebSocketController {
   ...
   * messages to /topic/messages and our client is subscribed to that topic.
   * Also in WSService we can implement a Scheduler which sends out messages to /topic/messages
   * at some fixed delay.
   */
